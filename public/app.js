  ...
  const node = el(`
    <main class="auth-wrap public-page">
      ...
      <section class="public-section features-section" id="features">
        ...
        <img class="features-illustration" src="/illustrations-final/features%20illustration.png?v=final-20260807" alt="Seven-step Card2Leads workflow: capture cards, extract details, review and clean, assign owner, search and find, export and sync, and save in Google Contacts." />
      </section>
